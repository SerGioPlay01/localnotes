!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, r) {
            ...
            var n = r(4),
                i = "function" == typeof Symbol && "symbol" === o(Symbol("foo")),
            ...
            (f.supportsDescriptors = !!p), (t.exports = f);
        },
        function (t, e, r) {
            function o(t) {
                return (o =
            ...
            (p.prototype.insert = function (t, e) {
                ...
                (p.prototype.slice = function (t, e) {
                    ...
                    for (
                        var r = [], o = a.iterator(this.ops), n = 0;
                        n < e && o.hasNext();

                    ) {
                        var i;
                        n < t ? (i = o.next(t - n)) : ((i = o.next(e - n)), r.push(i)),
                            (n += a.length(i));
                    }
                    return new p(r);
                }),
                (p.prototype.compose = function (t) {
                    ...
                    if (
                        ...
                        n.retain - s > 0 && r.next(n.retain - s);
                    }
                    for (var u = new p(o); e.hasNext() || r.hasNext();)
                        if ("insert" === r.peekType()) u.push(r.next());
                            ...
                            if ("number" == typeof l.retain) {
                                ...
                                if (
                                    (h && (y.attributes = h),
                                        u.push(y),
                                        !r.hasNext() && i(u.ops[u.ops.length - 1], y))
                                ) {
                                    var b = new p(e.rest());
                    ...
                    return (
                        s.forEach(function (t) {
                            for (var e = t[1].length; e > 0;) {
                                ...
                                switch (t[0]) {
                                    case n.INSERT:
                                        (r = Math.min(f.peekLength(), e)), o.push(f.next(r));
                                        break;
                                    case n.DELETE:
                                        (r = Math.min(e, c.peekLength())), c.next(r), o.delete(r);
                                        break;
                                    case n.EQUAL:
                                        ...
                                        i(s.insert, u.insert)
                                            ? o.retain(
                                                r,
                                                a.attributes.diff(s.attributes, u.attributes)
                                            )
                                            : o.push(u).delete(r);
                                }
                                e -= r;
                ...
                (p.prototype.eachLine = function (t, e) {
                    e = e || "\n";
                    for (
                        var r = a.iterator(this.ops), o = new p(), n = 0;
                        r.hasNext();
                        ...
                        if (u < 0) o.push(r.next());
                            ...
                            if (!1 === t(o, r.next(1).attributes || {}, n)) return;
                            (n += 1), (o = new p());
                        }
                    }
                    o.length() > 0 && t(o, {}, n);
                ...
                (p.prototype.transform = function (t, e) {
                    ...
                    for (
                        var r = a.iterator(this.ops), o = a.iterator(t.ops), n = new p();
                        r.hasNext() || o.hasNext();

                    )
                        if ("insert" !== r.peekType() || (!e && "insert" === o.peekType()))
                            if ("insert" === o.peekType()) n.push(o.next());
                            else {
                                var i = Math.min(r.peekLength(), o.peekLength()),
                                    s = r.next(i),
                                    u = o.next(i);
                                ...
                                u.delete
                                    ...
                                    : n.retain(
                                        i,
                                        a.attributes.transform(s.attributes, u.attributes, e)
                                    );
                            }
                        else n.retain(a.length(r.next()));
                    return n.chop();
                }),
                (p.prototype.transformPosition = function (t, e) {
                    e = !!e;
                    for (var r = a.iterator(this.ops), o = 0; r.hasNext() && o <= t;) {
                        var n = r.peekLength(),
                            i = r.peekType();
                        r.next(),
                            "delete" !== i
                                ? ("insert" === i && (o < t || !e) && (t += n), (o += n))
                                : (t -= Math.min(n, t - o));
                    }
                    return t;
                }),
        ...
        function (t, e, r) {
                ...
                return (
                    ...
                    (!t || !e || ("object" !== o(t) && "object" !== o(e))
                        ...
                        : (function (t, e, r) {
                            ...
                            for (v.sort(), S.sort(), s = v.length - 1; s >= 0; s--)
                                if (v[s] != S[s]) return !1;
                            for (s = v.length - 1; s >= 0; s--)
                                if (((h = v[s]), !f(t[h], e[h], r))) return !1;
                            return !0;
                        })(t, e, h))
                );
            }
            ...
            function y(t) {
                return (
                    !(!t || "object" !== o(t) || "number" != typeof t.length) &&
        ...
        function (t, e, r) {
            ...
            t.exports = function t() {
                var e,
                    ...
                    b = !1;
                for (
                    "boolean" == typeof l && ((b = l), (l = arguments[1] || {}), (y = 2)),
                    (null == l || ("object" !== o(l) && "function" != typeof l)) &&
                    (l = {});
                    y < h;
                    ++y
                )
                    if (null != (e = arguments[y]))
                        for (r in e)
                            (n = f(l, r)),
                                l !== (i = f(e, r)) &&
                                (b && i && (p(i) || (s = u(i)))
                                    ? (s
                                        ? ((s = !1), (a = n && u(n) ? n : []))
                                        : (a = n && p(n) ? n : {}),
                                        c(l, { name: r, newValue: t(b, a, i) }))
                                    : void 0 !== i && c(l, { name: r, newValue: i }));
                return l;
            };
        },
        function (t, e) {
                ...
                f = function (t, e) {
                    if (
                        ((e = (function (t) {
                            ...
                            Reflect.has(e, "normalizeHttps"))
                    )
                        throw new Error(
                            "options.normalizeHttps is renamed to options.forceHttp"
                        );
                    if (Reflect.has(e, "normalizeHttp"))
                        throw new Error(
                            "options.normalizeHttp is renamed to options.forceHttps"
                        );
                    if (Reflect.has(e, "stripFragment"))
                        throw new Error(
                            "options.stripFragment is renamed to options.stripHash"
                        );
                    if (((t = t.trim()), /^data:/i.test(t)))
                        return (function (t, e) {
                            var r = e.stripHash,
                                o = t.match(/^data:(.*?),(.*?)(?:#(.*))?$/);
                            if (!o) throw new Error("Invalid URL: ".concat(t));
                            var n = o[1].split(";"),
                                a = o[2],
                                u = r ? "" : o[3],
                                p = !1;
                            "base64" === n[n.length - 1] && (n.pop(), (p = !0));
                            var c = (n.shift() || "").toLowerCase(),
                                f = i(
                                    n
                                        .map(function (t) {
                                            var e = s(
                                            ...
                                            return "charset" === r &&
                                                ...
                                                ? ""
                                                : "".concat(r).concat(n ? "=".concat(n) : "");
                                        })
                                        .filter(Boolean)
                                );
                            return (
                                p && f.push("base64"),
                                (0 !== f.length || (c && "text/plain" !== c)) && f.unshift(c),
                                "data:"
                                    .concat(f.join(";"), ",")
                                    .concat(p ? a.trim() : a)
                                    .concat(u ? "#".concat(u) : "")
                    ...
                    if (
                        (e.forceHttp && "https:" === a.protocol && (a.protocol = "http:"),
                            e.forceHttps && "http:" === a.protocol && (a.protocol = "https:"),
                            e.stripAuthentication && ((a.username = ""), (a.password = "")),
                            e.stripHash && (a.hash = ""),
                            a.pathname &&
                            ...
                            a.pathname && (a.pathname = decodeURI(a.pathname)),
                        ...
                        var u = a.pathname.split("/"),
                            f = u[u.length - 1];
                        c(f, e.removeDirectoryIndex) &&
                            ((u = u.slice(0, u.length - 1)),
                                (a.pathname = u.slice(1).join("/") + "/"));
                    }
                    if (
                        (a.hostname &&
                            ((a.hostname = a.hostname.replace(/\.$/, "")),
                                e.stripWWW &&
                                /^www\.([a-z\-\d]{2,63})\.([a-z.]{2,5})$/.test(a.hostname) &&
                                (a.hostname = a.hostname.replace(/^www\./, ""))),
                            Array.isArray(e.removeQueryParameters))
                    )
                        for (var l = 0, y = i(a.searchParams.keys()); l < y.length; l++) {
                            var h = y[l];
                            c(h, e.removeQueryParameters) && a.searchParams.delete(h);
                        }
                    return (
                        e.sortQueryParameters && a.searchParams.sort(),
                        e.removeTrailingSlash &&
                        (a.pathname = a.pathname.replace(/\/$/, "")),
                        (t = a.toString()),
                        (!e.removeTrailingSlash && "/" !== a.pathname) ||
                        "" !== a.hash ||
                        (t = t.replace(/\/$/, "")),
        ...
        function (t, e, r) {
            ...
            var y = {
                ...
                normalizeUrlOptions: { stripWWW: !1 },
            },
                h = (function () {
                    function t(e, r) {
                        var o = this;
                        !(function (t, e) {
                            ...
                            (this.quill = e),
                            (r = r || {}),
                            (this.options = c(c({}, y), r)),
                            (this.urlNormalizer = function (t) {
                        ...
                        (r = [
                                    ...
                                    this.quill.clipboard.addMatcher(
                                        ...
                                        function (e, r) {
                                            if ("string" == typeof e.data) {
                                                var o = new n.a();
                                                return (
                                                    e.data.split(/(\s+)/).forEach(function (e) {
                                                        var r = e.match(t.options.globalRegularExpression),
                                                            n = e.match(
                                                                t.options.globalMailRegularExpression
                                                            ),
                                                            i = function (t, r) {
                                                                var n = e.split(t),
                                                                    i = n.shift();
                                                        ...
                                                        r && r.length
                                                            ? r.forEach(function (e) {
                                                                return i(e, t.urlNormalizer);
                                                            })
                                                            : n &&
                                                            n.length &&
                                                            n.forEach(function (e) {
                                                                return i(e, t.mailNormalizer);
                                                            }),
                                                            o.insert(e);
                                                    }),
                                                    (r.ops = o.ops),
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (t) {
                                        var e = a(this.quill.getLeaf(t.index), 1)[0];
                                        if (e.text && "a" !== e.parent.domNode.localName) {
                                            var r = this.quill.getIndex(e),
                                                o = e.text.match(this.options.urlRegularExpression),
                                                n = e.text.match(this.options.mailRegularExpression);
                                            o
                                                ? this.textToUrl(r + o.index, o[0])
                                                : n && this.textToMail(r + n.index, n[0]);
                                        }
                                    }
                                },
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var r = new n.a()
                                        .retain(t)
                                        .retain(e.length, { link: this.urlNormalizer(e) });
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var r = new n.a()
                                        .retain(t)
                                        .retain(e.length, { link: this.mailNormalizer(e) });
                                    this.quill.updateContents(r);
                                },
                            },
                            {
                                key: "normalize",
                                value: function (t) {
                                    if (this.options.normalizeRegularExpression.test(t))
                                        try {
            ...
            window.Quill && window.Quill.register("modules/magicUrl", h);
        },
        function (t, e) {
            function r(t, e, s) {
                if (t == e) return t ? [[0, t]] : [];
                ...
                var c = t.substring(t.length - u),
                    f = (function (t, e) {
                        ...
                        var c = (function (t, e) {
                            ...
                            function s(t, e, r) {
                                for (
                                    ...
                                    a,
                                    u,
                                    p = t.substring(r, r + Math.floor(t.length / 4)),
                                    c = -1,
                                    f = "";
                                    -1 != (c = e.indexOf(p, c + 1));

                                ) {
                                    var l = n(t.substring(r), e.substring(c)),
                                        y = i(t.substring(0, r), e.substring(0, c));
                                    f.length < y + l &&
                                        ((f = e.substring(c - y, c) + e.substring(c, c + l)),
                                            (o = t.substring(0, r - y)),
                                            (s = t.substring(r + l)),
                                            (a = e.substring(0, c - y)),
                                            (u = e.substring(c + l)));
                                }
                                return 2 * f.length >= t.length ? [o, s, a, u, f] : null;
                            }
                            var a,
                                u,
                                p,
                                c,
                                f,
                                l = s(r, o, Math.ceil(r.length / 4)),
                                y = s(r, o, Math.ceil(r.length / 2));
                            if (!l && !y) return null;
                            a = y ? (l && l[4].length > y[4].length ? l : y) : l;
                            t.length > e.length
                                ? ((u = a[0]), (p = a[1]), (c = a[2]), (f = a[3]))
                                : ((c = a[0]), (f = a[1]), (u = a[2]), (p = a[3]));
                            var h = a[4];
                            return [u, p, c, f, h];
                        })(t, e);
                        if (c) {
                            ...
                            for (
                                ...
                                for (var g = -d + y; g <= d - h; g += 2) {
                                    ...
                                    if (((u[v] = A), A > r)) h += 2;
                                        ...
                                        if ((O = s + f - g) >= 0 && O < a && -1 != p[O]) {
                                            var j = r - p[O];
                                            if (A >= j) return o(t, e, A, S);
                                        }
                                    }
                                }
                                for (var w = -d + b; w <= d - m; w += 2) {
                                    ...
                                    if (((p[O] = j), j > r)) m += 2;
                                        ...
                                        if ((v = s + f - w) >= 0 && v < a && -1 != u[v]) {
                                            var A = u[v];
                                            S = s + A - v;
                                            if (A >= (j = r - j)) return o(t, e, A, S);
                                        }
                                    }
                                }
                            }
                        ...
                        (t = t.substring(0, t.length - u)),
                        (e = e.substring(0, e.length - u))
                    );
                return (
                    p && f.unshift([0, p]),
                    c && f.push([0, c]),
                                ...
                                case 0:
                                    s + a > 1
                                        ? (0 !== s &&
                                            0 !== a &&
                                            (0 !== (r = n(p, u)) &&
                                                (o - s - a > 0 && 0 == e[o - s - a - 1][0]
                                                    ? (e[o - s - a - 1][1] += p.substring(0, r))
                                                    : (e.splice(0, 0, [0, p.substring(0, r)]), o++),
                                                    (p = p.substring(r)),
                                                    (u = u.substring(r))),
                                                0 !== (r = i(p, u)) &&
                                                ((e[o][1] = p.substring(p.length - r) + e[o][1]),
                                                    (p = p.substring(0, p.length - r)),
                                                    (u = u.substring(0, u.length - r)))),
                                            0 === s
                                                ? e.splice(o - a, s + a, [1, p])
                                                : 0 === a
                                                    ? e.splice(o - s, s + a, [-1, u])
                                                    : e.splice(o - s - a, s + a, [-1, u], [1, p]),
                                            (o = o - s - a + (s ? 1 : 0) + (a ? 1 : 0) + 1))
                                        : 0 !== o && 0 == e[o - 1][0]
                    ...
                    (f = (function (t, e) {
                        ...
                        if (null == i) return t;
                        if (0 !== i[0]) return t;
                        if (null != s && i[1] + s[1] === s[1] + i[1])
                            return o.splice(n, 2, s, i), a(o, n, 2);
                        if (null != s && 0 === s[1].indexOf(i[1])) {
                            o.splice(n, 2, [s[0], i[1]], [0, i[1]]);
                            var u = s[1].slice(i[1].length);
                            return (
                                u.length > 0 && o.splice(n + 2, 0, [s[0], u]), a(o, n, 3)
                            );
                        }
                        return t;
                    })(f, s)),
                    (f = (function (t) {
                        for (
                            ...
                            0 === t[o - 2][0] &&
                                (n = t[o - 2][1]).charCodeAt(n.length - 1) >= 55296 &&
                                n.charCodeAt(n.length - 1) <= 56319 &&
                                -1 === t[o - 1][0] &&
                                r(t[o - 1][1]) &&
                                1 === t[o][0] &&
                                r(t[o][1]) &&
            ...
            function n(t, e) {
                ...
                for (var r = 0, o = Math.min(t.length, e.length), n = o, i = 0; r < n;)
                    t.substring(i, n) == e.substring(i, n) ? (i = r = n) : (o = n),
                        (n = Math.floor((o - r) / 2 + r));
                return n;
            }
            function i(t, e) {
                if (!t || !e || t.charAt(t.length - 1) != e.charAt(e.length - 1))
                    return 0;
                for (var r = 0, o = Math.min(t.length, e.length), n = o, i = 0; r < n;)
                    t.substring(t.length - n, t.length - i) ==
                        e.substring(e.length - n, e.length - i)
                        ? (i = r = n)
                        : (o = n),
                        (n = Math.floor((o - r) / 2 + r));
                return n;
            ...
            var s = r;
            function a(t, e, r) {
                for (var o = e + r - 1; o >= 0 && o >= e - 1; o--)
                    if (o + 1 < t.length) {
                        var n = t[o],
                            i = t[o + 1];
                        n[0] === i[1] && t.splice(o, 2, [n[0], n[1] + i[1]]);
                    }
                return t;
            }
        ...
        function (t, e, r) {
            ...
            if (!Object.keys) {
                ...
                n = function (t) {
                    ...
                    if (n && t.length > 0)
                        for (var d = 0; d < t.length; ++d) y.push(String(d));
                    else
                        for (var g in t)
                            (b && "prototype" === g) || !i.call(t, g) || y.push(String(g));
                    if (p)
                        for (
                            var v = (function (t) {
                            ...
                            (v && "constructor" === f[S]) || !i.call(t, f[S]) || y.push(f[S]);
                    return y;
                };
            }
            t.exports = n;
        ...
        function (t, e, r) {
            ...
            var n = "function" == typeof Symbol && "symbol" === o(Symbol.toStringTag),
                i = Object.prototype.toString,
                s = function (t) {
                    return (
                        !(n && t && "object" === o(t) && Symbol.toStringTag in t) &&
                        "[object Arguments]" === i.call(t)
                    );
                },
                a = function (t) {
                    return (
        ...
        function (t, e, r) {
            ...
            var o = r(0),
                ...
                a = r(24),
                u = n(s(), Object);
            o(u, { getPolyfill: s, implementation: i, shim: a }), (t.exports = u);
        },
        function (t, e, r) {
            "use strict";
                ...
                for (
                    ...
                    a = function () {
                        if (this instanceof r) {
                            var o = e.apply(this, s.concat(n.call(arguments)));
                            return Object(o) === o ? o : this;
                        }
                        return e.apply(t, s.concat(n.call(arguments)));
                    },
                    u = Math.max(0, e.length - s.length),
                    p = [],
                    c = 0;
                    c < u;
                    c++
        ...
        function (t, e, r) {
            ...
            var s = function () {
                ...
                y = r(2).call(Function.call, String.prototype.replace),
                h =
                    /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
                b = /\\(\\)?/g,
                m = function (t) {
                    var e = [];
                    return (
                        y(t, h, function (t, r, o, n) {
                            e[e.length] = o ? y(n, b, "$1") : r || t;
                        }),
                        e
                    );
                },
            ...
            t.exports = function (t, e) {
                ...
                for (
                    var r = m(t), o = d("%" + (r.length > 0 ? r[0] : "") + "%", e), s = 1;
                    s < r.length;
                    s += 1
                )
                    if (null != o)
        ...
        function (t, e, r) {
            ...
            var n = r(26),
                ...
                u = "function" == typeof Symbol && "symbol" === o(Symbol.toStringTag);
            t.exports = function (t) {
        ...
        function (t, e, r) {
            ...
            var n = Date.prototype.getDay,
                i = Object.prototype.toString,
                s = "function" == typeof Symbol && "symbol" === o(Symbol.toStringTag);
            t.exports = function (t) {
                return (
                    "object" === o(t) &&
                    null !== t &&
        ...
        function (t, e, r) {
            ...
            (a.prototype.hasNext = function () {
                ...
                (a.prototype.peekLength = function () {
                    return this.ops[this.index]
                        ? s.length(this.ops[this.index]) - this.offset
                        : 1 / 0;
                }),
                ...
                (a.prototype.rest = function () {
                    if (this.hasNext()) {
                        ...
                        return (this.offset = t), (this.index = e), [r].concat(o);
                    }
                    return [];
                }),
                (t.exports = s);
        ...
        function (t, e, r) {
            ...
            (s.prototype.parse = function (t, e, r) {
                if (!i.isString(t))
                    throw new TypeError("Parameter 'url' must be a string, not " + o(t));
                var s = t.indexOf("?"),
                    u = -1 !== s && s < t.indexOf("#") ? "?" : "#",
                    c = t.split(u);
                c[0] = c[0].replace(/\\/g, "/");
                ...
                if (w) {
                    ...
                    (this.protocol = O), (S = S.substr(w.length));
                }
                if (r || w || S.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                    var x = "//" === S.substr(0, 2);
                    !x || (w && d[w]) || ((S = S.substr(2)), (this.slashes = !0));
                }
                if (!d[w] && (x || (w && !g[w]))) {
                    for (var A, P, E = -1, k = 0; k < y.length; k++) {
                        -1 !== (I = S.indexOf(y[k])) && (-1 === E || I < E) && (E = I);
                    }
                    -1 !== (P = -1 === E ? S.lastIndexOf("@") : S.lastIndexOf("@", E)) &&
                        ((A = S.slice(0, P)),
                            (S = S.slice(P + 1)),
                    ...
                    if (!U)
                        for (
                            var R = this.hostname.split(/\./), T = ((k = 0), R.length);
                            k < T;
                            k++
                        ) {
                            var C = R[k];
                            if (C && !C.match(h)) {
                                for (var N = "", F = 0, M = C.length; F < M; F++)
                                    C.charCodeAt(F) > 127 ? (N += "x") : (N += C[F]);
                                if (!N.match(h)) {
                                    var D = R.slice(0, k),
                                        $ = R.slice(k + 1),
                                        L = C.match(b);
                                    L && (D.push(L[1]), $.unshift(L[2])),
                                        $.length && (S = "/" + $.join(".") + S),
                    ...
                    this.hostname.length > 255
                        ...
                        U || (this.hostname = n.toASCII(this.hostname));
                ...
                (s.prototype.resolveObject = function (t) {
                    ...
                    for (
                        var r = new s(), o = Object.keys(this), n = 0;
                        n < o.length;
                        n++
                    ) {
                        var a = o[n];
                    ...
                    for (
                        ...
                        "." === (A = O[k])
                            ...
                            : ".." === A
                                ? (O.splice(k, 1), E++)
                                : E && (O.splice(k, 1), E--);
                    if (!j && !w) for (; E--; E) O.unshift("..");
                    !j ||
                        "" === O[0] ||
                        (O[0] && "/" === O[0].charAt(0)) ||
                        O.unshift(""),
                        P && "/" !== O.join("/").substr(-1) && O.push("");
                    var I,
                        U = "" === O[0] || (O[0] && "/" === O[0].charAt(0));
                    x &&
                        ((r.hostname = r.host = U ? "" : O.length ? O.shift() : ""),
                            (I = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) &&
                            ((r.auth = I.shift()), (r.host = r.hostname = I.shift())));
                    return (
                        (j = j || (r.host && O.length)) && !U && O.unshift(""),
                        O.length
                            ? (r.pathname = O.join("/"))
        ...
        /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (s) {
                    var a = "object" == i(e) && e && !e.nodeType && e,
                        ...
                        p = "object" == (void 0 === o ? "undefined" : i(o)) && o;
                    ...
                    function j(t, e) {
                        ...
                        return (
                            ...
                            o + S((t = t.replace(b, ".")).split("."), e).join(".")
                        );
                    }
                    function w(t) {
                    ...
                    function A(t, e, r) {
                        var o = 0;
                        for (t = r ? d(t / 700) : t >> 1, t += d(t / e); t > 455; o += 36)
                            t = d(t / 35);
                    ...
                    function P(t) {
                        ...
                        for ((r = t.lastIndexOf("-")) < 0 && (r = 0), o = 0; o < r; ++o)
                            t.charCodeAt(o) >= 128 && v("not-basic"), y.push(t.charCodeAt(o));
                        for (n = r > 0 ? r + 1 : 0; n < h;) {
                            for (
                                i = b, s = 1, a = 36;
                                n >= h && v("invalid-input"),
                                ...
                                v("overflow"),
                                (b += u * s),
                                !(u < (p = a <= g ? 1 : a >= g + 26 ? 26 : a - g));
                                a += 36
                            )
                                s > d(l / (c = 36 - p)) && v("overflow"), (s *= c);
                            (g = A(b - i, (e = y.length + 1), 0 == i)),
                                d(b / e) > l - m && v("overflow"),
                                (m += d(b / e)),
                                (b %= e),
                                y.splice(b++, 0, m);
                        }
                    ...
                    function E(t) {
                        var e,
                            ...
                            S = [];
                        for (
                            y = (t = w(t)).length, e = 128, r = 0, i = 72, s = 0;
                            s < y;
                            ++s
                        )
                            (f = t[s]) < 128 && S.push(g(f));
                        for (o = n = S.length, n && S.push("-"); o < y;) {
                            for (a = l, s = 0; s < y; ++s)
                                (f = t[s]) >= e && f < a && (a = f);
                            for (
                                a - e > d((l - r) / (h = o + 1)) && v("overflow"),
                                r += (a - e) * h,
                                e = a,
                                s = 0;
                                s < y;
                                ...
                                if (((f = t[s]) < e && ++r > l && v("overflow"), f == e)) {
                                    for (
                                        u = r, p = 36;
                                        !(u < (c = p <= i ? 1 : p >= i + 26 ? 26 : p - i));
                                        p += 36
                                    )
                                        (m = u - c),
                                            (b = 36 - c),
                                            S.push(g(x(c + (m % b), 0))),
                                            (u = d(m / b));
                                    S.push(g(x(u, 0))), (i = A(r, h, o == n)), (r = 0), ++o;
                                }
                            ++r, ++e;
                        }
                        return S.join("");
                    ...
                    if (
                        ...
                        if (t.exports == a) u.exports = c;
                        else for (f in c) c.hasOwnProperty(f) && (a[f] = c[f]);
                    else s.punycode = c;
                })(this);
