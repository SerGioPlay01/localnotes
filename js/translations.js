...
const translations = {
    en: {
        ...
        pdfImportNotSupported: "PDF import is not supported: \"{filename}\"",
        pdfImportSuggestion: "Please convert PDF to HTML or Markdown first, or use OCR tools.",
    ...
    ru: {
        ...
        pdfFiles: "PDF файлы (.pdf)",
        pdfImportNotSupported: "Импорт PDF не поддерживается: \"{filename}\"",
        pdfImportSuggestion: "Пожалуйста, сначала конвертируйте PDF в HTML или Markdown, или используйте OCR инструменты.",
    ...
    ua: {
        ...
        pdfFiles: "PDF файли (.pdf)",
        pdfImportNotSupported: "Імпорт PDF не підтримується: \"{filename}\"",
        pdfImportSuggestion: "Будь ласка, спочатку конвертуйте PDF в HTML або Markdown, або використовуйте OCR інструменти.",
    ...
    pl: {
        ...
        pdfFiles: "Pliki PDF (.pdf)",
        pdfImportNotSupported: "Import PDF nie jest obsługiwany: \"{filename}\"",
        pdfImportSuggestion: "Proszę najpierw przekonwertować PDF na HTML lub Markdown, lub użyć narzędzi OCR.",
    ...
    cs: {
        ...
        pdfFiles: "PDF soubory (.pdf)",
        pdfImportNotSupported: "Import PDF není podporován: \"{filename}\"",
        pdfImportSuggestion: "Prosím nejprve převeďte PDF na HTML nebo Markdown, nebo použijte OCR nástroje.",
    ...
    sk: {
        ...
        pdfFiles: "PDF súbory (.pdf)",
        pdfImportNotSupported: "Import PDF nie je podporovaný: \"{filename}\"",
        pdfImportSuggestion: "Prosím najprv preveďte PDF na HTML alebo Markdown, alebo použite OCR nástroje.",
    ...
    bg: {
        ...
        pdfFiles: "PDF файлове (.pdf)",
        pdfImportNotSupported: "Импортът на PDF не се поддържа: \"{filename}\"",
        pdfImportSuggestion: "Моля, първо конвертирайте PDF в HTML или Markdown, или използвайте OCR инструменти.",
    ...
    hr: {
        ...
        pdfFiles: "PDF datoteke (.pdf)",
        pdfImportNotSupported: "Import PDF nije podržan: \"{filename}\"",
        pdfImportSuggestion: "Molimo prvo pretvorite PDF u HTML ili Markdown, ili koristite OCR alate.",
    ...
    sr: {
        ...
        pdfFiles: "PDF датотеке (.pdf)",
        pdfImportNotSupported: "Увоз PDF није подржан: \"{filename}\"",
        pdfImportSuggestion: "Молимо прво конвертујте PDF у HTML или Markdown, или користите OCR алате.",
    ...
    mk: {
        ...
        pdfFiles: "PDF датотеки (.pdf)",
        pdfImportNotSupported: "Увозот на PDF не е поддржан: \"{filename}\"",
        pdfImportSuggestion: "Ве молиме прво конвертирајте PDF во HTML или Markdown, или користете OCR алатки.",
    ...
    sl: {
        ...
        markdownFiles: "Markdown datoteke (.md)",
        pdfFiles: "PDF datoteke (.pdf)",
        pdfImportNotSupported: "Uvoz PDF ni podprt: \"{filename}\"",
        pdfImportSuggestion: "Prosimo najpre pretvorite PDF v HTML ali Markdown, ali uporabite OCR orodja.",
