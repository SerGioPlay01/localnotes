                    ...
                    n.open(
                      ...
                      (n.onload = function () {
                        4 === n.readyState &&
                          ...
                          r.num_loaded++,
                          2 == r.num_loaded &&
                            (r.typo = new i("ru_RU", r.aff_data, r.dic_data, {
                              platform: "any",
                            })));
                      }),
                      n.send(null);
          ...
          !(function (e, i) {
            ...
            function Ke(e, t) {
              if ((t -= e.first) < 0 || t >= e.size)
                throw new Error(
                  "Нет ни одной строки " + (t + e.first) + " в этом документе."
                );
              for (var n = e; !n.lines; )
                for (var i = 0; ; ++i) {
                  var r = n.children[i],
      ...
      12: [
        function (e, t, n) {
          ...
          (i = function (e) {
            ...
            "object" == typeof n && "object" == typeof t
              ? i(e("/js/codemirror"), e("../xml/xml"), e("../meta"))
              : i(CodeMirror);
        },
        { "/js/codemirror": 10, "../meta": 13, "../xml/xml": 14 },
      ],
      13: [
        function (e, t, n) {
          (function (e) {
          ...
          !(function (e, i) {
            ...
            function A(e) {
              e &&
                ...
                !e.silent &&
                console.warn(
                  "marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: "
                );
            }
            function E(e, t) {
              if (t < 1) return "";
          ...
          var ee = {
            ...
            te = {
              ...
              "heading-bigger": {
                ...
                title: "Больше средного заголовок",
              },
              "heading-1": {
                name: "heading-1",
                action: S,
              ...
              "heading-3": {
                ...
                title: "Меньше среднего заголовок",
              },
            ...
            ae = {
              sbInit:
                "Прикрепляйте файлы перетаскиванием или вставкой из буфера обмена.",
              sbOnDragEnter: "Чтобы загрузить изображение, бросьте его.",
              sbOnDrop: "Загрузка изображения #images_names#...",
              sbProgress: "Загрузка  #file_name#: #progress#%",
              sbOnUploaded: "Загружено #image_name#",
              sizeUnits: " Б, КБ, МБ",
            },
            le = {
              noFileGiven: "Необходимо выбрать файл.",
              typeNotAllowed: "Этот тип изображения не разрешен.",
              fileTooLarge:
                "Изображение #image_name# слишком велико (#image_size#).\nМаксимальный размер файла составляет #image_max_size#.",
              importError:
                "Что-то пошло не так при загрузке изображения #image_name#.",
            };
          function se(e) {
            (e = e || {}).parent = this;
            var t = !0;
            ...
            if (e.element) this.element = e.element;
              ...
              return void console.log("Ошибка: элемент не найден.");z
            if (void 0 === e.toolbar)
            ...
            (se.prototype.updateStatusBar = function (e, t) {
              if (this.gui.statusbar) {
                ...
                1 === n.length
                  ...
                  : 0 === n.length
                  ? console.log(
                      "Редактор: элемент строки состояния " + e + "не найден."
                    )
                  : console.log(
                      "Редактор: несколько элементов строки состояния с именем " +
                        e +
                        "было найдено."
                    );
              }
              ...
              if (ue()) {
                ...
                if (
                  ...
                  return void console.log(
                    "Edit: You must set a uniqueId to use the autosave feature"
                  );
                ...
                if (null != n && null != n && "" != n) {
                  var i = new Date(),
                    r = new Intl.DateTimeFormat(
                      [this.options.autosave.timeFormat.locale, "ru-RU"],
                ...
                console.log(
                  "Edit: localStorage not available, cannot autosave"
                );
            }),
            (se.prototype.clearAutosavedValue = function () {
              if (ue()) {
                if (
                  ...
                  return void console.log(
                    "Edit: You must set a uniqueId to clear the autosave value"
                  );
                localStorage.removeItem(
                  "smde_" + this.options.autosave.uniqueId
                );
